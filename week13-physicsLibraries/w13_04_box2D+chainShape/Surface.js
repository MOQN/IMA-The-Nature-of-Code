function Surface() {
  ...
  this.surface.push(new box2d.b2Vec2(0, 400));
  this.surface.push(new box2d.b2Vec2(200, height-10));
  this.surface.push(new box2d.b2Vec2(500, 200));
  this.surface.push(new box2d.b2Vec2(600, height));
