...
class Particle {
  ...
  applyNoise3D() {
    ...
    var x = map(cos(frameCount * 0.02), -1, 1, 0, 1); 
    var y = map(sin(frameCount * 0.02), -1, 1, 0, 1); // a circular movement?
    var z = map(sin(frameCount * 0.027), -1, 1, 0, 1); // any arbitrary value
